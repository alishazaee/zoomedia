...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://postgres:postgres@127.0.0.1:5432/zoomedia'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'zoomedia.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'zoomedia.api.exception_handlers.hacksoft_proposed_exception_handler',
